...
import { CableSubscriptionTransactions } from '../Data/Transactoins'
import BarGraph from '../Components/BarChart'
import MetricCard from '../Components/MetricCard'
import TotalTransactionIcon from '../assets/flat-color-icons_sales-performance.png'
import MetricsImg3 from '../assets/avgTransactionValPerUser.png'
...
function CableSubscription({setFullDetails,setShowFullDetails}) {
    const filterTransactions = CableSubscriptionTransactions.filter(((transaction) => {
    ...
    return (
        <Box paddingLeft='20px' h='auto'>
            <Flex justifyContent='space-between' mt='20px'>
                ...
                <MetricCard MetricsImg={MetricsImg3} MerticsTitle='Avg  Revenue per User' MetricsValue='0'/>
            ...
            >
                ...
                <Box mt='20px'>
                    <OtherTransactionContainer
                        ...
                        Transactions={CableSubscriptionTransactions}
